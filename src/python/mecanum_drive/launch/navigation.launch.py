"""navigation.launch.py — Python mecanum_drive (reference implementation)

Full autonomous navigation stack. Mirrors mecanum_drive_cpp/launch/navigation.launch.py.
