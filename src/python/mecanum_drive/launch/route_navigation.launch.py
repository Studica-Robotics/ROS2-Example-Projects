"""route_navigation.launch.py — Python mecanum_drive (reference implementation)

Route-server navigation. Mirrors mecanum_drive_cpp/launch/route_navigation.launch.py.
...
Usage:
  ros2 launch mecanum_drive route_navigation.launch.py \\
      map:=$HOME/maps/my_room.yaml graph:=$HOME/maps/my_graph.geojson
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('graph', description='Path to GeoJSON route graph.'),
        ...
        TimerAction(
            ...
            actions=[
                ...
                Node(
                    ...
                    name='route_server',
                    output='screen',
                    parameters=[nav2_params, {'graph_filepath': graph_path}],
                ),
